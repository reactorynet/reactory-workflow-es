...
| 1 | C1 | Working distributed lock + queue providers; optimistic concurrency | Cloud | Critical | `[claude]` | spec | `specs/c1-distributed-providers.md` |
| 2 | H2 | Close lock-release race (post-processing inside lock) | Both | High | `[claude]` | spec | `specs/h2-lock-release-race.md` |
...
| 6 | C2 | Embedded SQLite/file persistence provider (Electron unlock) | Electron | Critical | `[claude]` | spec | `specs/c2-embedded-persistence.md` |
